...
PYBIND11_MODULE(jax_plate_lib, m) {
    ...
    py::class_<InnerState>(m, "InnerState")
            ...
            .def("matvec", &InnerState::matvec<double, int32_t>)
            .def("matvec", &InnerState::matvec<complex128_t, int32_t>)
            .def("matvec", &InnerState::matvec<double, int64_t>)
            .def("matvec", &InnerState::matvec<complex128_t, int64_t>);
}
